  ...
  return (
    <div className="font-sans antialiased text-gray-900 bg-white min-h-screen flex flex-col">
      ...
      */}
      ...
      <main className="flex-grow flex items-center justify-center bg-[var(--bg-light)] relative overflow-hidden">
        {/* Background Pattern/Gradient for Glass Effect context */}
        <div className="absolute inset-0 bg-gradient-to-br from-[var(--bg-light)] to-[var(--bg-dark)] z-0"></div>
        ...
        <div className="max-w-2xl w-full bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl p-12 text-center relative z-10 border border-white/40 animate-fade-in-up">
          ...
          <h1 className="text-4xl md:text-5xl font-serif font-bold text-[var(--text-main)] mb-6">
            Obrigado!
          </h1>

          <div className="w-24 h-1 bg-[var(--primary)] mx-auto mb-8 rounded-full"></div>
          ...
          <p className="text-gray-600 mb-10 leading-relaxed max-w-lg mx-auto">
            Nossa equipe de especialistas analisará seu perfil e entrará em
            contato em breve para apresentar as melhores oportunidades da{" "}
            {CONTENT.companyName}.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <a
              href="/"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white font-bold uppercase tracking-widest rounded shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto transform hover:-translate-y-1"
            >
