    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <motion.h1
          ...
          className="text-[var(--text-inverse)] font-serif text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 leading-tight drop-shadow-lg"
        >
          {CONTENT.hero.title} <br />
          <span className="italic font-light text-[var(--primary)] drop-shadow-md">
        ...
        >
          <a href={CONTENT.hero.ctaPrimaryLink}>
            <Button className="bg-[var(--primary)] hover:bg-[var(--primary-dark)] text-white rounded-none px-8 py-6 text-sm uppercase tracking-widest min-w-[200px] shadow-lg">
