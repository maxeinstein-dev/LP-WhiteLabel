...
export function Projects() {
  ...
  const settings = {
    ...
    customPaging: (i: number) => (
      <div className="w-3 h-3 mt-8 mx-1 rounded-full bg-gray-300 hover:bg-[var(--primary)]/50 transition-colors data-[slick-active=true]:bg-[var(--primary)]"></div>
    ),
    appendDots: (dots: any) => (
      <div>
  ...
  return (
    <section
      id="projects"
      className="py-20 bg-[var(--bg-light)] overflow-hidden relative"
    >
      <link
        rel="stylesheet"
        type="text/css"
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col items-center mb-16">
          ...
          >
            ...
            <div className="w-24 h-1 bg-[var(--primary)] mb-4"></div>
            {/* PROJECTS_SUBTITLE */}
            <p className="text-gray-600 max-w-xl text-center text-[15px] font-[Lato]">
              ...
              <div key={project.id} className="h-full">
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <span className="inline-flex items-center text-[var(--primary)] text-xs font-bold uppercase tracking-widest hover:text-[var(--primary-dark)] transition-colors group/link">
                      Ver Detalhes
              ...
              >
                ...
                <div className="w-full md:w-1/2 p-8 overflow-y-auto bg-white">
                  <div className="hidden md:block mb-6">
                    <h3 className="text-3xl font-serif font-bold text-[var(--text-main)] mb-2">
                      {selectedProject.title}
                    </h3>
                  ...
                  <a
                    ...
                    onClick={() => {
                      window.dispatchEvent(
                        new CustomEvent("projectInterest", {
